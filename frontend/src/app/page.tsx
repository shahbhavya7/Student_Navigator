    ...
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      <div className="z-10 max-w-5xl w-full items-center justify-center font-mono text-sm">
          ...
          {mounted && (
            <div className="text-sm opacity-70">
              <p className={isTracking ? "text-green-500" : "text-gray-500"}>
                {isTracking ? "✓ Tracking Active" : "⚠ Tracking Inactive"} | {eventCount} events captured
              </p>
            </div>
          )}
        </div>
        ...
        <div className="mt-8 flex justify-center gap-4">
          <div className="load-indicator low w-4 h-4 rounded-full" title="Low cognitive load"></div>
          <div className="load-indicator medium w-4 h-4 rounded-full" title="Medium cognitive load"></div>
          <div className="load-indicator high w-4 h-4 rounded-full" title="High cognitive load"></div>
        </div>
